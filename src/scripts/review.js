class ReviewManager {
  constructor() {
    ...
    this.cardManager = new CardManager({
      ...
      adjEl: document.getElementById('reviewCardAdj'),
      advEl: document.getElementById('reviewCardAdv'),
      adjWrapperEl: document.getElementById('reviewCardAdjWrapper'),
      advWrapperEl: document.getElementById('reviewCardAdvWrapper'),
      mode: 'review',
